...
import img1 from './assets/DSC05303.webp';
import img2 from './assets/DSC05322.webp';
import img3 from './assets/DSC05363.webp';
import img4 from './assets/DSC05389.webp';
import img5 from './assets/Prastuti Hero Image.webp';
import img6 from './assets/Prastuti Hero Image 2.webp';
import img7 from './assets/DSC05391.webp';
import img8 from './assets/DSC05407.webp';
  ...
  return (
    <div className="w-full py-12 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="Utility-font-Montserrat Utility-color-Blue text-2xl xs:text-3xl sm:text-4xl lg:text-5xl  font-bold text-center mb-8 text-gray-800">
