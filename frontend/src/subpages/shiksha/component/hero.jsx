        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-8 sm:py-12 lg:py-0">
          ...
          <div className="flex-1 flex justify-center lg:justify-end relative">
            ...
            >
              ...
              <div
                className="absolute -top-4 -left-4 lg:top-12 xs:-top-6 xs:-left-6 sm:-top-8 sm:-left-8 w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r  from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center text-white text-lg xs:text-xl sm:text-2xl shadow-lg animate-bounce z-30"
