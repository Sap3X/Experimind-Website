...
import scimg from "./assets/prasmain (1).webp";
...
export default function Prastuti() {
  return (
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      {/* Hero Section */}
      <div
        className="relative mb-10 min-h-screen w-full overflow-hidden "
        style={{
      ...
      >
        ...
        <div className="relative z-10 min-h-screen w-full flex items-center px-4 sm:px-6 lg:px-8 xl:px-12 py-16 lg:py-0">
          <div className="w-full max-w-7xl mx-auto">
            <div className="pt-16 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
              {/* Left Content */}
              <div className="text-center lg:text-left order-1 lg:order-1">
                ...
                <p className="text-white/90 text-sm sm:text-base lg:text-lg xl:text-xl leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
                  ...
                  Grades 8, 9 & 10. Transform your classroom into an interactive
                  learning environment with hands-on activities that make
