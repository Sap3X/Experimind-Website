  ...
  return (
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      {/* Container with proper spacing */}
        ...
        {/* Hero Section */}
        <div className="relative mb-10 min-h-screen w-full overflow-hidden " style={{ background: 'linear-gradient(135deg, #3186e7 0%, #1a5bb8 100%)' }}>
          {/* Background Elements */}
        ...
        <div className="space-y-4 lg:space-y-6">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-xl">
            <p className="text-gray-800 text-base sm:text-lg leading-relaxed">
              <span className="font-bold text-blue-700">Prastuti</span> is a revolutionary chapter-wise demonstration kit specifically designed for 
              <span className="font-semibold"> Grades 8, 9 & 10 Science and Math</span>, 
              perfectly aligned with the <span className="font-semibold">NCERT curriculum</span>.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-xl">
            <p className="text-gray-800 text-base sm:text-lg leading-relaxed">
              ...
              <span className="font-bold"> hands-on activities</span> directly in the classroom, 
              transforming lessons into <span className="font-semibold">interactive, visual, and engaging experiences</span> 
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-xl">
            <p className="text-gray-800 text-base sm:text-lg leading-relaxed">
              ...
              No technical expertise needed! Prastuti brings the laboratory experience 
              <span className="font-semibold"> directly into your classroom</span>, 
...
{/* Video Section */}
<section className="py-12 sm:py-16 bg-gray-100 mb-10">
    ...
    <div className="bg-gradient-to-b from-gray-300 to-gray-600 rounded-md h-64 sm:h-80 lg:h-96 flex items-center justify-center">
      <div className="text-center">
        <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
          <svg className="w-8 h-8 sm:w-10 sm:h-10 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clipRule="evenodd" />
          </svg>
        </div>
        <p className="text-white text-lg sm:text-xl font-semibold">Demo Video Coming Soon</p>
      </div>
    </div>
  </div>
</section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 lg:gap-8">
              {[
                ...
                <div key={index} className={`text-center group cursor-pointer ${
                  index === 4 ? 'sm:col-span-2 sm:justify-self-center lg:col-span-1 lg:justify-self-auto xl:col-span-1' : ''
                }`}>
        ...
        {/* Contact Section */}
        <section id="contact" className="py-12 sm:py-16 lg:py-20 xl:py-24 bg-gradient-to-r from-blue-800 to-blue-600 ">
          <div className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-white text-base sm:text-lg lg:text-xl xl:text-2xl mb-8 lg:mb-12 leading-relaxed max-w-3xl mx-auto">
                Transform the way STEM, AI, and Robotics are taught. Contact us to bring Prastuti to your school today!
              </p>
              <button 
