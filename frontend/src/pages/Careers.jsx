                    ...
                    <label htmlFor="resume" className="flex items-center justify-between cursor-pointer">
                      <div className="text-left">
                        <div className="font-medium">
                          {internFormData.resume ? internFormData.resume.name : 'Click to upload resume'}
                        </div>
                        <div className="text-sm text-gray-500">
                          {internFormData.resume ? `PDF (${(internFormData.resume.size / 1024 / 1024).toFixed(2)} MB)` : 'PDF only (max: 5MB)'}
                        </div>
                      </div>
