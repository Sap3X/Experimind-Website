  ...
  <div className="max-w-7xl mx-auto ">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-3">
      ...
      {[
        ...
        { name: "Mike Johnson", linkedin: "https://linkedin.com/in/mikejohnson" },
        { name: "Sarah Wilson", linkedin: "https://linkedin.com/in/sarahwilson" },
        { name: "David Brown", linkedin: "https://linkedin.com/in/davidbrown" },
        { name: "Emily Davis", linkedin: "https://linkedin.com/in/emilydavis" },
        { name: "Alex Miller", linkedin: "https://linkedin.com/in/alexmiller" },
        { name: "Lisa Garcia", linkedin: "https://linkedin.com/in/lisagarcia" },
        { name: "Chris Taylor", linkedin: "https://linkedin.com/in/christaylor" },
        { name: "Amy Anderson", linkedin: "https://linkedin.com/in/amyanderson" },
        { name: "Tom Wilson", linkedin: "https://linkedin.com/in/tomwilson" },
        { name: "Nina Martinez", linkedin: "https://linkedin.com/in/ninamartinez" }
      ].map((member, index) => (
        <div key={index} className="flex flex-col items-center text-center">
          ...
          <div className="w-28 h-28 sm:w-32 sm:h-32 lg:w-28 lg:h-28 rounded-full bg-gray-300 flex items-center justify-center mb-4 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="w-14 h-14 sm:w-16 sm:h-16 lg:w-14 lg:h-14 rounded-full bg-gray-500 flex items-center justify-center">
              <svg className="w-7 h-7 sm:w-8 sm:h-8 text-gray-300" fill="currentColor" viewBox="0 0 20 20">
